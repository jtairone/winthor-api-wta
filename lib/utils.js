...
class Cliente {
    constructor(cliente){
      const mapeiaCampos = {	
        activityId: { nome:'CODIGOATIVIDADE', tipo:'number' }, //Number 6                                                                     Obrigátorio
        billingAddress: { nome: "ENDERECOCOBRANCA", tipo: 'string', tamanho: 40 }, //String 40 PCLIENT.ENDERCOD                            Obrigátorio
        ...
        billingZipCode: { nome: "CEPCOBRANCA", tipo: 'string', tamanho: 9 }, //STRING 9 PCCLIENT.CEPCOB                                    Obrigátorio
        businessDistrict: { nome: "BAIRROCOMERCIAL", tipo: 'string', tamanho: 40 }, //STRING 40 PCCLIENT.BAIRROENT                         Obrigátorio
        businessState: {nome: "BAIRROCOMERCIAL", tipo: 'string', tamanho: 2 }, //STRING 2 PCCLIENT.ESTENT
        cityId: { nome:"CODIGOCIDADE", tipo: 'number' }, //NUMVER 10 PCCLIENT.CODCIDADE                                                    Obrigátorio //VALIDAR SE ENVIANDO commercialZipCode NÃO É NECESSARIO ENVIAR
        commercialAddress: { nome: "ENDERECOCOMERCIAL", tipo: 'string', tamanho: 40 }, //STRING 40 PCCLIENT.ENDERENT                       Obrigátorio
        commercialAddressNumber: { nome:"NUMNEROCOMERCIAL", tipo:"string", tamanho: 6 }, //STRING 6 PCCLIENT.NUMEROENT
        commercialZipCode: { nome: "CEPCOMERCIAL", tipo:"string", tamanho: 9 }, //STRING 9 PCCLIENT.CEPCOM                                 Obrigátorio
        ...
        email: { nome:"EMAIL", tipo:'string', tamanho: 100 }, //STRING 100 PCCLIENT.EMAIL                                                   Obrigátorio //validar se e obrigatorio
       ...
       // lastChange: { nome:"DATAULTIMAALTERACAO", tipo:'date' }, //DATE 7 PCCLIENT.DTULTALTER                                             Obrigatorio //Informa obrigatorio na doc mais acredito que não
        name: { nome:"NOMECLIENTE", tipo:'string', tamanho: 60 }, //STRING 60 PCCLIENT.CLIENTE                                              Obrigátorio
        paymentPlanId: { nome:"CODIGOPLANOPAGAMENTO", tipo:'number' }, //NUMBER 4 PCCLIENT.CODPLPAG
        personIdentificationNumber: { nome:"CNPJ", tipo:'string', tamanho: 18 }, //STRING 18 PCCLIENT.CGCENT  CNPJF/CPF                     Obrigatorio
        sellerId: { nome:"CODIGOVENDEDOR", tipo:'number' }, //NUMVBER 4 PCCLIENT.CODUSUR1                                                   Obrigatorio
        squareId: { nome:"CODIGOPRACA", tipo:'number' }, //NUMBER 6 PCCLIENT.CODPRACA                                                       Obrigatorio
        stateInscription: { nome:"INSCRICAOESTADUAL", tipo:'number' }, //NUMBER 6 PCCLIENT.IEENT                                            Obrigatorio
